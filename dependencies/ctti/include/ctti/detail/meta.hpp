...
namespace meta
{
	...
	// Stormancer: This does not build with Visual Studio: 
	// error C3547: template parameter 'Indices' cannot be used because it follows a template parameter pack and cannot be deduced from the function parameters of 'ctti::meta::detail::foreach'
	// This is not needed for our type_id usage, so no big deal.
    //template<typename Seq>
