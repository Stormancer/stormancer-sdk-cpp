	...
	namespace Party
	{
		...
		namespace details
		{
			...
			private:
				...
				///
				pplx::task<void> setStormancerReadyStatus(const std::string gameFinderName)
				{
					_clientReady = false;
					if (gameFinderName != "")
					{
				...
				///
				pplx::task<void> sendPlayerPartyStatus()
				{
					...
					return _rpcService->rpc<void>("party.updategamefinderplayerstatus", sendStatus);
				}
