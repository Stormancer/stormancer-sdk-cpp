...
namespace Stormancer
{
	...
	public:
		...
		STORMANCER_DLL_API void schedulePeriodic(int delay, std::function<void()> work, const pplx::cancellation_token& ct) override;
	...
	private:
		...
		static void periodicFunc(std::function<void()> work, const pplx::cancellation_token& ct, std::weak_ptr<TimerThread> weakTimer, std::chrono::milliseconds delay);
