...
namespace Stormancer
{
	...
	public:
		...
		~ApiClient();
		pplx::task<SceneEndpoint> getSceneEndpoint(std::string accountId, std::string applicationName, std::string sceneId, pplx::cancellation_token ct = pplx::cancellation_token::none());
